// runtime/src-tauri/lib/content/legal.ts
// Phase 3i: legal documents content for the Instagram Automation Platform.
// Recovered from commit 025ca5f (pre-React-purge) and relocated into the
// kernel tree, alongside contracts/, controllers/, domains/, ipc/,
// substrates/. Originally at src/content/legalContent.ts.
//
// Meta Compliance: February 3, 2025 Requirements.
// Consumers: the Svelte legal page (src/lib/svelte/Legal.svelte) renders
// these sections. No React consumer exists — the React pages were
// purged in 3g.
